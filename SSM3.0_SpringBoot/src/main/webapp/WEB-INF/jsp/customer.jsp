...
<%--引入自定义标签库（分页） --%>
<%@ taglib prefix="jyt" uri="http://jingyuntao9527.com/common/"%>
<%
...
<body>
							...
							<tbody>
								...
								<tr>
									<td colspan="8"><a href="#"
										...
										data-target="#customerAddDialog">添加</a></td>
								</tr>
							</tbody>
						</table>
	...
	<script type="text/javascript">
		...
		function addCustomer(){
			$.post("<%=basePath%>customer/save.action",$("#add_customer_form").serialize(),function(data){
				alert("客户信息添加成功！");
				window.location.reload();
			});
